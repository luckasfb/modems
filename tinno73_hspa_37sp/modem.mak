...
BOARD_VER         =  TINNO73_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        =  TINNO73_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
COM_DEFS_FOR_TINNO73_LCM = TINNO73_LCM
