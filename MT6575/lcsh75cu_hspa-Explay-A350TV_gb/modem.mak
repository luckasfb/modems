...
BOARD_VER         = LCSH75CU_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        = LCSH75CU_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
COM_DEFS_FOR_LCSH75CU_LCM = LCSH75CU_LCM
