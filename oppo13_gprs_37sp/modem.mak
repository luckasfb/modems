...
BOARD_VER         =  OPPO13_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        =  OPPO13_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
COM_DEFS_FOR_OPPO13_LCM = OPPO13_LCM
