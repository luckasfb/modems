...
BOARD_VER         =  UNISTAR13_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        =  UNISTAR13_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
COM_DEFS_FOR_UNISTAR13_LCM = UNISTAR13_LCM
